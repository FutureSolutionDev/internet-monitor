...
const LANGS = {
  ar: {
    ...
    availability_title: "التوفّر",
    av_today: "اليوم",
    av_week: "آخر 7 أيام",
    av_month: "آخر 30 يوم",
    copy_summary: "نسخ الملخّص",
    copied: "تم النسخ ✅",
    ...
    export_csv_7: "CSV — 7 أيام",
    export_csv_30: "CSV — 30 يوم",
    export_partial: "تعذّر تحميل بعض الأيام؛ قد يكون التصدير ناقصاً.",
    log_count: "سجل",
    ...
    restart_required: "⚠️ يلزم إعادة تشغيل التطبيق لتطبيق منفذ لوحة التحكم الجديد",
    ...
    update_checking: "⏳ جاري الفحص...",
    update_uptodate: "✅ أنت على أحدث إصدار",
    update_check_err: "❌ تعذّر الفحص",
    ...
    speed_ul_target: "عنوان اختبار الرفع (فارغ = إيقاف الرفع)",
    speed_ul_note: "الافتراضي: speed.cloudflare.com/__up — اتركه فارغاً لتعطيل قياس الرفع",
    speed_parallel: "اتصالات متوازية (1–8)",
    speed_alert_threshold: "حد التنبيه (Mbps، 0 = معطّل)",
    speed_schedule_minutes: "اختبار تلقائي كل (دقيقة، 0 = معطّل)",
    ...
    diag_isp: "الشبكة المحلية سليمة — العطل عند المزود (ISP)",
    diag_lan: "لا يمكن الوصول للراوتر — مشكلة في الشبكة المحلية",
    speed_running: "جاري القياس...",
    speed_uploading: "الرفع",
    speed_downloading: "التنزيل",
    speed_idle: "جاهز",
    speed_starting: "جارٍ البدء…",
    speed_ping: "زمن الاستجابة",
    speed_done: "✅ اكتمل",
  ...
  en: {
    ...
    export_csv_7: "CSV — 7 days",
    export_csv_30: "CSV — 30 days",
    export_partial: "Some days failed to load; export may be incomplete.",
    log_count: "record",
    ...
    restart_required: "⚠️ Restart required for the new dashboard port to take effect",
    ...
    speed_ul_target: "Upload test URL (empty = upload disabled)",
    speed_ul_note: "Default: speed.cloudflare.com/__up — leave empty to disable upload measurement",
    speed_parallel: "Parallel connections (1–8)",
    speed_alert_threshold: "Alert threshold (Mbps, 0 = disabled)",
    speed_schedule_minutes: "Auto test every (minutes, 0 = disabled)",
    ...
    diag_isp: "LAN is fine — outage is at the ISP",
    diag_lan: "Can't reach the router — local network issue",
    speed_running: "Testing...",
    speed_uploading: "Upload",
    speed_downloading: "Download",
    speed_idle: "Ready",
    speed_starting: "Starting…",
    speed_ping: "Ping",
    speed_done: "✅ Done",
